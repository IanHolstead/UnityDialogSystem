...
//Code largely from: http://gram.gs/gramlog/creating-node-based-editor-unity/
public class NodeBasedEditor : EditorWindow {
	...
	private void ProcessNodeEvents(Event e){
		if(nodes != null){
			//Note: Order is reversed because the last node is drawn  at the top, it should process the events first
